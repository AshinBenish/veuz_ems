app.service('ToastService', function () {
    this.show = function (type, message) {
        ...
        toast.className = `
            ...
            rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800
        `;
        ...
        toast.innerHTML = `
            ...
            <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 
                hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 
                hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 
